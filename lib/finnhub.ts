 ...
 * without it we'd burn 59 calls per scan (one per ticker). With it, ONE
...
/**
 * Company-specific news in a date window. Per-ticker, so for 59-ticker
 * watchlist this is 59 calls. Cache aggressively (30 min TTL).
 *
