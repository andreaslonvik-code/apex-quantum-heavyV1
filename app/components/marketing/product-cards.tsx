...
const COPY = {
  no: {
    ...
    max: {
      ...
      price: '4 990 kr',
      cycle: '/mnd',
      desc: 'Den autonome trading-motoren. Grok-4-Heavy analyserer markedsdynamikk og utfører aksjehandel for deg via Alpaca, døgnet rundt. Lansering planlagt 2026.',
      bullets: [
        'Fullautomatisk handel via Alpaca',
        'Grok-4-Heavy AI med selvlærende parametere',
  ...
  en: {
    ...
    max: {
      ...
      price: '$499',
      cycle: '/month',
      desc: 'The autonomous trading engine. Grok-4-Heavy analyzes market dynamics and executes equity trading for you via Alpaca, around the clock. Launch planned 2026.',
      bullets: [
        'Fully automated trading via Alpaca',
        'Grok-4-Heavy AI with self-tuning parameters',
